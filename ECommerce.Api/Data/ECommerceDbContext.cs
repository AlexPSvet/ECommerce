...
namespace ECommerce.Api.Data
{
    public class ECommerceDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new() { Id = Guid.NewGuid(), Name = "Laptop", Category = Category.Electronics, Description = "High-performance laptop", Price = 999.99m, Stock = 10 },
                new() { Id = Guid.NewGuid(), Name = "Mouse", Category = Category.Electronics, Description = "Wireless mouse", Price = 29.99m, Stock = 50 },
                new() { Id = Guid.NewGuid(), Name = "Keyboard", Category = Category.Electronics, Description = "Mechanical keyboard", Price = 79.99m, Stock = 30 },
                new() { Id = Guid.NewGuid(), Name = "Monitor", Category = Category.Electronics, Description = "4K Monitor 27 inch", Price = 399.99m, Stock = 15 },
                new() { Id = Guid.NewGuid(), Name = "Webcam", Category = Category.Electronics, Description = "HD Webcam", Price = 59.99m, Stock = 25 }
            };
